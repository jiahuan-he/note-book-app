...
export const ACTION = {
    ...
    NOTE_SAVE_START: "NOTE_SAVE_START",
    NOTE_SAVE_ERROR : "NOTE_SAVE_ERROR",
    NOTE_SAVE_SUCCESS: "NOTE_SAVE_SUCCESS",
    FETCH_NOTEBOOKS_START: "FETCH_NOTEBOOKS_START",
    ...
    PAGE_EDIT: "PAGE_EDIT",
    NOTEBOOK_EDIT_SUCCESS: "NOTEBOOK_EDIT_SUCCESS",
    NOTEBOOK_EDIT_START: "NOTEBOOK_EDIT_START",
    NOTEBOOK_EDIT_ERROR: "NOTEBOOK_EDIT_ERROR",
    ...
    PAGE_DELETE_START: "PAGE_DELETE_START",
    PAGE_DELETE_SUCCESS: "PAGE_DELETE_SUCCESS",
    NOTEBOOK_DELETE_PENDING : "NOTEBOOK_DELETE_PENDING",
};
